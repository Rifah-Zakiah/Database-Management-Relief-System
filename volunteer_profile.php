...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query to fetch volunteer details using ID or NID
    $sql = "SELECT * FROM Volunteer WHERE id = '$search_value' OR nid = '$search_value'";
...
<!-- Input form for volunteer ID or NID -->
...
<?php if (!empty($volunteer_data)): ?>
    ...
    <div class="profile">
        ...
        <p><strong>NID:</strong> <?php echo htmlspecialchars($volunteer_data['nid']); ?></p>
